...
class _StatsTabState extends State<StatsTab> {
  ...
  Future<void> _fetchStats() async {
    try {
      ...
      const List<String> keys = ['humidity'];
      ...
      if (response.statusCode == 200) {
        ...
        final DateTime lastRealTs =
            DateTime.fromMillisecondsSinceEpoch(data['humidity'].first['ts']);
        ...
        debugPrint('Humidity Spots: $humiditySpots');
        debugPrint('Predicted Humidity Spots: $predictedHumiditySpots');
      } else {
        setState(() {
  ...
  Future<List<FlSpot>> _fetchPredictions(
    ...
    if (response.statusCode == 200) {
      ...
      final List<dynamic> predHumidity = data['pred_humid_list'];
  ...
  //   if (picked != null) {
  //     setState(() => _startTs_df = picked);
  //     if (_endTs_df.isAfter(picked))
  //       _fetchStats();
  //     else {
  //       // _result = 'End date must be after start date.';
  //       _validDate = false;
  //     }
  //   }
  // }
  ...
  List<FlSpot> parseHumiditySpots(Map<String, dynamic> json) {
    final List<dynamic> humidityData = json['humidity'];
        ...
        if (humiditySpots.isEmpty)
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Padding(
              ...
              child: Text(
                'Humidity Over Time', // Your chart title here
                style: TextStyle(
                  fontSize: 18,
